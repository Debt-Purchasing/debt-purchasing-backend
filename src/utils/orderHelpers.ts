 ...
 */
export function hashOrderTitle(order: IFullSellOrder | IPartialSellOrder): string {
 ...
 */
export function createFullSellOrderStructHash(chainId: number, contractAddress: string, order: IFullSellOrder): string {
